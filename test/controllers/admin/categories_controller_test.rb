...
class Admin::CategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_category" do
    assert_difference("Admin::Category.count") do
      post admin_categories_url, params: { admin_category: { description: @admin_category.description, name: @admin_category.name, parent_id: @admin_category.parent_id } }
    end
  ...
  test "should update admin_category" do
    patch admin_category_url(@admin_category), params: { admin_category: { description: @admin_category.description, name: @admin_category.name, parent_id: @admin_category.parent_id } }
